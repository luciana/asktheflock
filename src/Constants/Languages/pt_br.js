const pt_br_lang = {
  ...
  HomePage: {
    ...
    DetailedAnalysis: "Analisar o resultado",
    ...
    WaitThereIsMore:"Peraí Que Tem Mais",
    Features: "Features",
  },
  Stats: {
  ...
  Comments: {
    ...
    CommentBubbleTitle: "Gostaria de justificar sua escolha",
    CommentAlreadyDoneBubbleTitle: "Você já justificou sua escolha" ,
  },
  Questions:{
    Questions: "Perguntas",
  ...
  Profile: {
    ...
    OnlyExpertTagMissing: "Qual a sua especialidade? Adicione no seu perfil. Sua opinião valerá mais para certas pessoas!",
    OnlyAddressMissing: "Adicione seu cep no perfil para ajudar com decisões locais.",
    ...
    OnlyGenderMissing: "Diversidade de opiniões é importante. Adicione seu gênero no perfil.",
    Joined: "Membro desde",  
