...
const Input = ({ type, label, placeholder, value, handler, showTooltip, error, required = false, disabled }) => {
  const [inputType, setInputType] = useState(type);

  const grayoutField = disabled ? disabled : false;
